...
/**
 * <p>AdditionalLogisticUnitIdentificationType complex type�� ���� Java Ŭ�����Դϴ�.
 * 
 * <p>���� ��Ű�� ������ �� Ŭ������ ���ԵǴ� �ʿ��� �������� �����մϴ�.
 * 
 * <pre>
...
public class AdditionalLogisticUnitIdentificationType {
    ...
    /**
     * additionalLogisticUnitIdentificationTypeCode �Ӽ��� ���� �����ɴϴ�.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * additionalLogisticUnitIdentificationTypeCode �Ӽ��� ���� �����մϴ�.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
